export const OWNER = "neptunianimpact";
export const REPO = "modelpanda";
...
export const SAAS_CHAT_URL = "https://modelpanda.ai";
export const SAAS_CHAT_UTM_URL = "https://modelpanda.ai";
